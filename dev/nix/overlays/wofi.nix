...
{
  wofi = super.stdenv.mkDerivation rec {
    pname = "wofi";
    version = "1.1.2";
    ...
    nativeBuildInputs =
      [ super.pkg-config super.meson super.ninja super.wrapGAppsHook ];
    buildInputs = [ super.wayland super.gtk3 ];
    ...
    patches = [
      (super.fetchpatch {
        url =
          "https://paste.sr.ht/blob/1cbddafac3806afb203940c029e78ce8390d8f49";
