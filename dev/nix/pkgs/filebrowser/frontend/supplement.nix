...
let
  sources = {
    "@ant-design-vue/babel-helper-vue-compatible-props-1.0.0" = {
      name = "_at_ant-design-vue_slash_babel-helper-vue-compatible-props";
      packageName = "@ant-design-vue/babel-helper-vue-compatible-props";
      version = "1.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@ant-design-vue/babel-helper-vue-compatible-props/-/babel-helper-vue-compatible-props-1.0.0.tgz";
        sha512 = "BHOaxm9EJOqoBYWUMVFKwjgDkdqbGnY1KhQBJwTdrQGRDVjVXkxzyoDGJV52YAGgHQrdaSMWakwZIiTfncsNJQ==";
      };
    };
    ...
    "@ant-design-vue/babel-plugin-jsx-1.0.0-beta.4" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@ant-design-vue/babel-plugin-jsx/-/babel-plugin-jsx-1.0.0-beta.4.tgz";
        sha512 = "x0zJ0I8oy+LUMnnFQ8kByxHRH2v6kwO5xyRkwlbM/d0rGzcifmh+NgnpX35TMqi6jsjJu3He4WVsYbWVu1SWGg==";
      };
    };
    ...
    "@vue/babel-preset-app-4.5.0" = {
      ...
      version = "4.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@vue/babel-preset-app/-/babel-preset-app-4.5.0.tgz";
        sha512 = "xYhstD8kUpky7y2uDhuasm6jy8+K39wj2NtIyFfOdQFnzWGUEqBrDWVwe+I8tcZI9H/uaVY+O3iJCFQP4dDahQ==";
      };
    };
    ...
    "@vue/cli-overlay-4.5.0" = {
      ...
      version = "4.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@vue/cli-overlay/-/cli-overlay-4.5.0.tgz";
        sha512 = "23FUa+mmkou7z0lxMPRst0V+qDtqWK4Imh42iNYxg7FEMCtH1NnGigOt6WHG4SHRkSYY0D3JMwT7FJ3JI6vx2w==";
      };
    };
    "@vue/cli-plugin-router-4.5.0" = {
      ...
      version = "4.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@vue/cli-plugin-router/-/cli-plugin-router-4.5.0.tgz";
        sha512 = "R2YewoUc9ZC1iBVzweWQv++LUVQ+Q58tehTLvUQXxOyo4aRWYVc6IfRAmhRVf8+VTDckYVccGaQNWd2CMcOfKQ==";
      };
    };
    "@vue/cli-plugin-vuex-4.5.0" = {
      ...
      version = "4.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@vue/cli-plugin-vuex/-/cli-plugin-vuex-4.5.0.tgz";
        sha512 = "O9TdcR0NDwtCB8CoRSOtPd8KlqQGT9/PZRicvKMTt8F3q5G1zIgKeEEbWlez5Il8wKLnGDOpVOHpQSCIykTs5A==";
      };
    };
    ...
    "electron-to-chromium-1.3.509" = {
      ...
      version = "1.3.509";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.509.tgz";
        sha512 = "cN4lkjNRuTG8rtAqTOVgwpecEC2kbKA04PG6YijcKGHK/kD0xLjiqExcAOmLUwtXZRF8cBeam2I0VZcih919Ug==";
      };
    };
    "elliptic-6.5.3" = {
      name = "elliptic";
    ...
    "portfinder-1.0.27" = {
      ...
      version = "1.0.27";
      src = fetchurl {
        url = "https://registry.npmjs.org/portfinder/-/portfinder-1.0.27.tgz";
        sha512 = "bJ3U3MThKnyJ9Dx1Idtm5pQmxXqw08+XOHhi/Lie8OF1OlhVaBFhsntAIhkZYjfDcCzszSr0w1yCbccThhzgxQ==";
      };
    };
    ...
    "webpack-chain-6.5.0" = {
      ...
      version = "6.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/webpack-chain/-/webpack-chain-6.5.0.tgz";
        sha512 = "K4EHiEg4WlP4w1rKXKpYWvX9cfGBERHCGP06ETSNV62XUIfOUg1DDRQpxyBsFYxZLKc4YUAI3iiCIvWoliheGA==";
      };
    };
...
in
{
  "@vue/cli-service" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."@vue/cli-overlay-4.5.0"
      sources."@vue/cli-plugin-router-4.5.0"
      sources."@vue/cli-plugin-vuex-4.5.0"
      ...
      sources."ejs-2.7.4"
      sources."electron-to-chromium-1.3.509"
  ...
  "@vue/cli-plugin-babel" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      sources."@ant-design-vue/babel-helper-vue-compatible-props-1.0.0"
      sources."@ant-design-vue/babel-helper-vue-transform-on-1.0.1"
      sources."@ant-design-vue/babel-plugin-jsx-1.0.0-beta.4"
      sources."@babel/code-frame-7.10.4"
      ...
      (sources."@vue/babel-preset-app-4.5.0" // {
        dependencies = [
          sources."semver-6.3.0"
        ];
      })
  ...
  "@vue/cli-plugin-eslint" = nodeEnv.buildNodePackage {
